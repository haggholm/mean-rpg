...
module.exports = app.controller('AttributeValueCtrl', function($scope, ModelService) {
  ModelService.Attribute.query(function(attrs) {
    ...
    var simDataKeys = _.map(data, function(v){ return v[0]; })
    ...
    var chartOptions = {
      ...
      tooltipContent: function(key, x, y/*, e, graph*/) {
        ...
        return(
          ...
          '<p>Vs. '+opponentLevel+': '+percentFormat(Number(y))+' chance of winning'+
          '</p></div>'
        );
      },
      barColor: function(v) {
      ...
      showLegend: false,
      showValues: true,
      x: function(v) { return v.vs; },
      y: function(v) { return v.pct; },
      showXAxis: false,
      showYAxis: false,
      stacked: false
    };
